...
function ProfilRisikoKinerjaContent() {
  ...
  const filteredRisiko = useMemo(() => {
    ...
    result = result.filter((r: any) => {
      ...
      return kategori.includes("kinerja");
    });
      ...
      <div className="flex-1">
        ...
        <div className="p-6 space-y-6 max-w-full text-gray-900">
          <div className="bg-white p-4 rounded-xl shadow mt-6 text-gray-900">
            <h2 className="font-bold mb-3">1. Profil Risiko Kinerja</h2>
            ...
            <div className="flex gap-2 mb-3">
              ...
              <button
                onClick={() => {
                  ...
                  router.push(
                    `/risiko/kinerja/tambah?komitmenId=${selectedKomitmen}`,
                  );
                }}
    ...
    <Suspense
      fallback={
        <div className="flex min-h-screen items-center justify-center bg-gray-100 text-gray-900">
          Memuat data profil risiko kinerja...
        </div>
      }
    >
      <ProfilRisikoKinerjaContent />
    </Suspense>
  );
}